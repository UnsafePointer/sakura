...
const std::array<InstructionHandler<T>, 0x100> INSTRUCTION_TABLE = {
  ...
  /*0+*/ NULL,    NULL,      NULL,    ST0,   NULL,   ORA_ZP, NULL, RMB_I, NULL, ORA_IMM,   ASL_ACC, NULL, NULL,      NULL,      NULL,      NULL,
  ...
  /*6+*/ RST,     NULL,      CLA,     NULL,  STZ_ZP, NULL,   NULL, RMB_I, PLA,  ADC_IMM,   NULL,    NULL, NULL,      NULL,      NULL,      NULL,
  ...
  /*B+*/ NULL,    LDA_IND_Y, LDA_IND, NULL,  NULL,   NULL,   NULL, SMB_I, NULL, LDA_ABS_Y, NULL,    NULL, NULL,      LDA_ABS_X, NULL,      NULL,
