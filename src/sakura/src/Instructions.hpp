...
const std::array<InstructionHandler<T>, 0x100> INSTRUCTION_TABLE = {
  ...
  /*2+*/ JSR,     NULL,      SAX,     ST2,   BIT_ZP,   AND_ZP,   ROL_ZP,   RMB_I, PLP,  AND_IMM,   ROL_ACC, NULL, BIT_ABS,     AND_ABS,   ROL_ABS,   BBR_I,
  /*3+*/ BMI,     NULL,      NULL,    NULL,  NULL,     AND_ZP_X, ROL_ZP_X, RMB_I, SEC,  AND_ABS_Y, DEC_ACC, NULL, NULL,        AND_ABS_X, ROL_ABS_X, BBR_I,
