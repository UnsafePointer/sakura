...
const std::array<InstructionHandler<T>, 0x100> INSTRUCTION_TABLE = {
  ...
  /*1+*/ BPL,     NULL,      NULL,    NULL,  NULL,   NULL,     ASL_ZP_X, RMB_I, CLC,  ORA_ABS_Y, INC_ACC, NULL, NULL,        ORA_ABS_X, NULL,      BBR_I,
  /*2+*/ JSR,     NULL,      SAX,     NULL,  NULL,   NULL,     ROL_ZP,   RMB_I, PLP,  AND_IMM,   NULL,    NULL, NULL,        NULL,      NULL,      BBR_I,
  ...
  /*B+*/ BCS,     LDA_IND_Y, LDA_IND, NULL,  NULL,   LDA_ZP_X, NULL,     SMB_I, NULL, LDA_ABS_Y, TSX,     NULL, NULL,        LDA_ABS_X, NULL,      NULL,
  /*C+*/ CPY_IMM, NULL,      CLY,     NULL,  NULL,   NULL,     DEC_ZP,   SMB_I, INY,  CMP_IMM,   DEX,     NULL, NULL,        CMP_ABS,   DEC_ABS,   NULL,
  /*D+*/ BNE,     NULL,      NULL,    NULL,  CSH,    NULL,     DEC_ZP_X, SMB_I, CLD,  NULL,      PHX,     NULL, NULL,        CMP_ABS_X, DEC_ABS_X, NULL,
