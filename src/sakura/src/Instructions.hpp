...
const std::array<InstructionHandler<T>, 0x100> INSTRUCTION_TABLE = {
  ...
  /*9+*/ BCC,     STA_IND_Y, STA_IND, NULL,  NULL,     STA_ZP_X, STX_ZP_Y, SMB_I, TYA,  STA_ABS_Y, TXS,     NULL, STZ_ABS,     STA_ABS_X, STZ_ABS_X, BBS_I,
  /*A+*/ LDY_IMM, NULL,      LDX_IMM, NULL,  LDY_ZP,   LDA_ZP,   LDX_ZP,   SMB_I, TAY,  LDA_IMM,   TAX,     NULL, LDY_ABS,     LDA_ABS,   LDX_ABS,   BBS_I,
  /*B+*/ BCS,     LDA_IND_Y, LDA_IND, NULL,  LDY_ZP_X, LDA_ZP_X, LDX_ZP_Y, SMB_I, CLV,  LDA_ABS_Y, TSX,     NULL, NULL,        LDA_ABS_X, LDX_ABS_Y, BBS_I,
