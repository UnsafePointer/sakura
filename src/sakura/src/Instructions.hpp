...
const std::array<InstructionHandler<T>, 0x100> INSTRUCTION_TABLE = {
  ...
  /*1+*/ BPL,     NULL,      NULL,    ST1,   NULL,   NULL,     ASL_ZP_X, RMB_I, CLC,  ORA_ABS_Y, INC_ACC, NULL, NULL,        ORA_ABS_X, NULL,      BBR_I,
  ...
  /*6+*/ RST,     NULL,      CLA,     NULL,  STZ_ZP, ADC_ZP,   NULL,     RMB_I, PLA,  ADC_IMM,   NULL,    NULL, JMP_ABS_IND, ADC_ABS,   NULL,      BBR_I,
  /*7+*/ NULL,    NULL,      ADC_IND, NULL,  NULL,   NULL,     NULL,     RMB_I, SEI,  ADC_ABS_Y, PLY,     NULL, JMP_ABS_X,   ADC_ABS_X, NULL,      BBR_I,
  /*8+*/ BRA,     NULL,      CLX,     NULL,  STY_ZP, STA_ZP,   STX_ZP,   SMB_I, DEY,  BIT_IMM,   TXA,     NULL, NULL,        STA_ABS,   STX_ABS,   BBS_I,
  /*9+*/ BCC,     STA_IND_Y, STA_IND, NULL,  NULL,   STA_ZP_X, NULL,     SMB_I, TYA,  STA_ABS_Y, TXS,     NULL, STZ_ABS,     STA_ABS_X, STZ_ABS_X, BBS_I,
  /*A+*/ LDY_IMM, NULL,      LDX_IMM, NULL,  LDY_ZP, LDA_ZP,   LDX_ZP,   SMB_I, TAY,  LDA_IMM,   TAX,     NULL, LDY_ABS,     LDA_ABS,   LDX_ABS,   BBS_I,
  /*B+*/ BCS,     LDA_IND_Y, LDA_IND, NULL,  NULL,   LDA_ZP_X, NULL,     SMB_I, NULL, LDA_ABS_Y, TSX,     NULL, NULL,        LDA_ABS_X, NULL,      BBS_I,
  /*C+*/ CPY_IMM, NULL,      CLY,     NULL,  NULL,   NULL,     DEC_ZP,   SMB_I, INY,  CMP_IMM,   DEX,     NULL, NULL,        CMP_ABS,   DEC_ABS,   BBS_I,
  /*D+*/ BNE,     NULL,      NULL,    NULL,  CSH,    NULL,     DEC_ZP_X, SMB_I, CLD,  NULL,      PHX,     NULL, NULL,        CMP_ABS_X, DEC_ABS_X, BBS_I,
  /*E+*/ CPX_IMM, NULL,      NULL,    TIA,   CPX_ZP, NULL,     INC_ZP,   SMB_I, INX,  SBC_IMM,   NOP,     NULL, NULL,        NULL,      INC_ABS,   BBS_I,
  /*F+*/ BEQ,     NULL,      NULL,    TAI,   NULL,   NULL,     NULL,     SMB_I, NULL, NULL,      PLX,     NULL, NULL,        NULL,      INC_ABS_X, BBS_I,
};
// clang-format on
